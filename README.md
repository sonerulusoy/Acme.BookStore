...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 91c6a030-8789-47a9-9978-12fa7acea2f3
```

> `91c6a030-8789-47a9-9978-12fa7acea2f3` is the password of the certificate, you can change it to any password you want.
